...
**배포 URL** — https://codyssey-a1-3-j2yrdm120-codyssey3.vercel.app/index.html
...
Framework Preset을 Python으로 지정하면 단일 진입점(`pyproject.toml`의 entrypoint 선언)을 요구하기 때문에, 정적 파일과 `api/` 서버리스 함수로 구성된 이 프로젝트에서는 Other를 사용해야 한다.
